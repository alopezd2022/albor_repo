...
def generate_launch_description():
    ...
    pkg_share_folder = get_package_share_directory("albor_description")
        ...
        [
            generate_load_controller_launch_description(
                ...
                controller_params_file=join(
                    pkg_share_folder, 'config', 'albor_controllers.yaml'))
        ],
    )
    ...
    arm_pkg_share_folder = get_package_share_directory("albor_moveit_config")
